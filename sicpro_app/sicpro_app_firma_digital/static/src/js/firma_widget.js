odoo.define('sicpro_app_firma_digital.Signature', function (require) {
    "use strict";
    ...
    const SignatureDialog = require('sicpro_app_firma_digital.firma_dialog');
...
registry.add('firma', FieldBinarySignature);
