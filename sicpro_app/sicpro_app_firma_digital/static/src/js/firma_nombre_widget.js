odoo.define('sicpro_app_firma_digital.name_and_signature', function (require) {
'use strict';
...
var NameAndSignature = Widget.extend({
    template: 'firma_digital.nombre_firma',
    xmlDependencies: ['/sicpro_app_firma_digital/static/src/xml/firma.xml'],
    events: {
        // name
    ...
    init: function (parent, options) {
        ...
        this.displaySignatureRatio = options.displaySignatureRatio || 1.0;
    ...
    _getSVGText: function (font, text, width, height) {
        var $svg = $(core.qweb.render('firma_digital.firma_svg_text', {
            width: width,
            height: height,
            font: font,
            text: text,
