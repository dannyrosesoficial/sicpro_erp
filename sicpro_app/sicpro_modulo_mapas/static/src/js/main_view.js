odoo.define('sicpro_modulo_mapas.SolverMapOL', function (require) {
"use strict";
...
var solmap_common = require('sicpro_modulo_mapas.solmap_common');
       ...
       this.map.on('click',self._onMarkerClick.bind(self));
        ...
        var iconStyle = new ol.style.Style({
            image: new ol.style.Icon({
                ...
                anchorYUnits: 'pixels',
                imgSize : [32,32],
                src: '/sicpro_modulo_mapas/static/imgs/map-marker.png',
            }),
      });
...
var SolverMapView = BasicView.extend(solmap_common.SolMapMixin,{
    ...
    init: function (viewInfo, params) {
        ...
        var self = this;
        this._loadOlMapTemplate('sicpro.modulo.mapas',function(data){
...
viewRegistry.add('map', SolverMapView);
