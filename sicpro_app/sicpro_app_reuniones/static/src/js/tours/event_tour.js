odoo.define('sicpro.app.reuniones_steps', function (require) {
"use strict";
...
odoo.define('sicpro.app.reuniones_tour', function (require) {
"use strict";
...
var EventAdditionalTourSteps = require('sicpro.app.reuniones_steps');
...
tour.register('event_tour', {
    ...
    trigger: '.o_app[data-menu-xmlid="sicpro.app.reuniones_main_menu"]',
    ...
    trigger: '.o_event_form_view input[name="fecha_fin"]',
    content: _t("When will your event take place? <b>Select</b> the start and end dates <b>and click Apply</b>."),
    run: function () {
        $('input[name="fecha_inicio"]').val('09/30/2020 08:00:00').change();
        $('input[name="fecha_fin"]').val('10/02/2020 23:00:00').change();
    },
}, {
