...
class ResUsers(models.Model):
    ...
    chatter_position = fields.Selection(
        ...
        string="Estado del Chat", default='normal')

    def __init__(self, pool, cr):
        """  Anulación de __init__ para agregar derechos de acceso.
        Los derechos de acceso están deshabilitados de forma predeterminada,
        pero se permiten en algunos campos definidos en self.SELF_
        {READ / WRITE} ABLE_FIELDS.
                """
