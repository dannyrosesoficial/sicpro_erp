...
class BaseAutomation(models.Model):
    ...
    def _register_hook(self):
        ...
        for action_rule in self.with_context({}).search(
            ...
            # Do not crash if the models of the base_action_rule was uninstalled
            if Model is None:
                _logger.warning("Action rule with ID %d depends on models %s" %
                                (action_rule.id,
