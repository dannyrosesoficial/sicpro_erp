...
class ResConfigSettings(models.TransientModel):
    ...
    style = fields.Selection([('default', 'Defecto'), ('left', 'Izquierda'),
                              ('right', 'Derecha'), ('middle', 'Centro')],)
    background = fields.Selection([('image', 'Image'), ('color', 'Color')], default='color')
    background_image = fields.Many2one('sicpro.modulo.web.login.imagen', string="Imagen",)
