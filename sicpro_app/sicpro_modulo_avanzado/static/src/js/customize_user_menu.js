odoo.define('sicpro_modulo_avanzado.UserMenu', function (require) {
    "use strict";
    ...
    var support_url = '#';
    var account_title = 'Mi SICPRO ERP';
    var account_url = '#';
            ...
            self._rpc({
                ...
                _.each(res, function (lang) {
                    ...
                    lang_list += '<a role="menuitem" href="#" class="dropdown-item" data-lang-menu="lang" data-lang-id="' + lang['code']
                        + '"><img class="flag" src="sicpro_modulo_avanzado/static/src/img/flags/' + lang['code'] + '.png"/>' + lang['name'] + a + '</a>';
                });
