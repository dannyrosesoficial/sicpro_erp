...
class ViviendaAnexo4(models.TransientModel):
    ...
    def report_busca_programa(self):
        ...
        if self.reporte_general:
            ...
            records = self.env['sicpro.app.vivienda.trabajador'].sudo().search([('estado', '=', 'logistica')])
            ...
            for obj in records:
                ...
                data = {'nombre': obj.trabajador_id.name, 'via_m_r': obj.tipo_mtto_reparacion,
                        'via_t': obj.tipo_terminada, 'inicio': obj.etapa.fecha_inicio, 'cierre': obj.etapa.fecha_fin,
                        'monto': monto, 'observaciones': obj.descripcion, }
            ...
            if self.etapa:
                ...
                records = self.env['sicpro.app.vivienda.trabajador'].sudo().search(
                    ['&', ('etapa', '=', self.etapa.id), ('estado', '=', 'logistica')])
    ...
    def generar_reporte(self):
        return self.env.ref('sicpro_app_programa_viviendas.informe_modelo_vivienda_anexo_4_action').report_action([], )
