...
class QuickModelUpgrade(models.TransientModel):
    ...
    def get_recent_modules(self):
        return self.env['modules.upgrade.history'].search(
            [('last_update_module_date', '!=', False)],
            order="last_update_module_date desc", limit=5).ids
    ...
    recent_module_ids = fields.Many2many(
        ...
        'wizard_id', 'module_id', string='Recent Upgraded Modules',
