odoo.define('sicpro_app_dashboard.BoardView', function (require) {
"use strict";
...
var BoardRenderer = FormRenderer.extend({
    ...
    init: function (parent, state, params) {
        ...
        this.actionsDescr = {};
        this._boardSubcontrollers = [];
        this._boardFormViewIDs = {};
    },
    /**
     * @override
     */
    ...
    _onCloseAction: function (event) {
        ...
        Dialog.confirm(this, (_t("Realmente desea eliminar el diseño de su dashboard?")), {
...
var BoardView = FormView.extend({
    ...
    display_name: _lt('Dashboard Personal'),
...
var BoardView = require('sicpro_app_dashboard.BoardView');
