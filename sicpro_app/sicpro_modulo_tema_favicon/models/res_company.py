...
class ResCompany(models.Model):
    ...
    def _get_default_favicon(self, original=False):
        img_path = odoo.tools.misc.file_path("sicpro_modulo_tema_favicon/static/src/img/favicon.png")
    ...
    favicon = fields.Binary(string="Favicon", default=lambda self: self._get_default_favicon())
