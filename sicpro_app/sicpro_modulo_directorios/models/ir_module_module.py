...
class IrModule(models.Model):
    ...
    addons_path_id = fields.Many2one('sicpro.app.administracion.directorio.app',
                                     string='Directorio de App', readonly=True)
    addons_path = fields.Char(string='Directorio de Aplicaciones',
                              related='addons_path_id.path', readonly=True)
...
class BaseModuleUpdate(models.TransientModel):
    ...
    def update_addons_paths(self):
        ...
        addons_path_obj = self.env['sicpro.app.administracion.directorio.app']
