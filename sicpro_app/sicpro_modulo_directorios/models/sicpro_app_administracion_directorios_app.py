...
class SicproDirectorioApp(models.Model):
    _name = "sicpro.app.administracion.directorio.app"
    _description = 'Registro de los directorios de las App'
    ...
    path = fields.Char(string='Directorio')
