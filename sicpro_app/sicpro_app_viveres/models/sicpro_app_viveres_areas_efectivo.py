...
class ViveresAreasEfectivo(models.Model):
    ...
    total_trabajadores = fields.Integer(string='Total área',
                                        compute='_compute_total_trabajadores',
                                        readonly=True)
    total_entregado = fields.Integer(string='Total entregado', required=True)
    monto_individual_entregado = fields.Monetary(string='Monto individual',
                                                 currency_field='company_currency',
                                                 required=True)
    monto_total_entregado = fields.Monetary(string='Monto total',
                                            compute='_compute_monto_total_entregado',
                                            readonly=True,
                                            currency_field='company_currency')
