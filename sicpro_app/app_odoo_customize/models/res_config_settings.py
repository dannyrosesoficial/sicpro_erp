...
class ResConfigSettings(models.TransientModel):
    ...
    app_show_documentation_dev = fields.Boolean(
        'Mostrar documentación del desarrollador',
    ...
    app_documentation_dev_url = fields.Char('URL de documentación del '
                                            'desarrollador')
    ...
    def set_values(self):
        ...
        ir_config.set_param("app_show_support",
                            self.app_show_support or "False")
        ir_config.set_param("app_show_account",
                            self.app_show_account or "False")
        ir_config.set_param("app_show_enterprise",
                            self.app_show_enterprise or "False")
        ir_config.set_param("app_show_share", self.app_show_share or "False")
        ir_config.set_param("app_show_poweredby",
                            self.app_show_poweredby or "False")
        ...
        ir_config.set_param("app_account_title",
                            self.app_account_title or "Mi cuenta SICPRO")
        ir_config.set_param("app_account_url", self.app_account_url or "#")
        ir_config.set_param("app_enterprise_url",
                            self.app_enterprise_url or "#")

    def set_module_url(self):
        sql = "UPDATE ir_module_module SET website = '%s' " \
              "WHERE license like '%s' and website <> ''" \
