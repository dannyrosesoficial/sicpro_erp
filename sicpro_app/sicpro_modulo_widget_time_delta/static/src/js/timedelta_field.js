...
export class TimeDeltaField extends Component {
    ...
    static template = "sicpro_modulo_widget_time_delta.FieldTimeDelta";
    ...
    setup() {
        ...
        onWillStart(async () => {
            await loadJS('/sicpro_modulo_widget_time_delta/static/src/lib/duration-picker/jquery-duration-picker.js');
            await loadJS('/sicpro_modulo_widget_time_delta/static/src/lib/duration-humanize/humanize-duration.js');
        });
...
export const timeDeltaField = {
    ...
    displayName: _t("Time Delta Field"),
