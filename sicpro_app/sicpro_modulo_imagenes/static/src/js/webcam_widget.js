odoo.define('sicpro_modulo_imagenes.webcam_widget', function(require) {
    "use strict";
    ...
    imageWidget.include({
        ...
        _render: function () {
            ...
            Webcam.set({
                ...
                force_flash: false,
                fps: 45,
                swfURL: '/sicpro_modulo_imagenes/static/src/js/webcam.swf',
                //force_flash: true,
            });
...
/*            new Model('ir.config_parameter').call('get_param', ['web_widget_image_webcam.flash_fallback_mode', false]).
            ...
            self.$el.find('.o_form_binary_file_web_cam').off().on('click', function(){
                ...
                new Dialog(self, {
                    ...
                    buttons: [
                        {
                            text: _t("Capturar Imagen"), classes: 'btn-primary take_snap_btn',
                            click: function () {
                ...
                WebCamDialog.find("#webcam_result").html('<img src="/sicpro_modulo_imagenes/static/src/img/webcam_placeholder.png"/>');
            });
        },
    });
