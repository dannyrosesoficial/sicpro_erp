odoo.define('sicpro_app_trabajadores/static/src/models/partner/partner.js', function (require) {
'use strict';
...
registerInstancePatchModel('mail.partner', 'sicpro_app_trabajadores/static/src/models/partner/partner.js', {
    //--------------------------------------------------------------------------
    // Public
    //--------------------------------------------------------------------------
    ...
    async checkIsEmployee() {
        await this.async(() => this.env.models['sicpro.app.trabajadores'].performRpcSearchRead({
...
registerFieldPatchModel('mail.partner', 'sicpro_app_trabajadores/static/src/models/partner/partner.js', {
    /**
