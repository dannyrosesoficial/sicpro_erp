odoo.define('sicpro_app_contratos.BoardView', function (require) {
"use strict";
...
var BoardController = FormController.extend({
     ...
     */
    getTitle: function () {
        return _t("Dashboard de Contratación");
    },
    ...
    _saveDashboard: function () {
        ...
        var arch = QWeb.render('DashBoard_contratos.xml', _.extend({}, board));
        return this._rpc({
    ...
    _onChangeLayout: function (event) {
        ...
        var dialog = new Dialog(this, {
            title: _t("Editar Diseño"),
            $content: QWeb.render('DashBoard_contratos.layouts', _.clone(event.data))
        });
...
var BoardRenderer = FormRenderer.extend({
    ...
    _renderTagBoard: function (node) {
        ...
        if (!hasAction) {
            return $(QWeb.render('DashBoard_contratos.NoContent'));
        }

        // We should start with three columns available
        node = $.extend(true, {}, node);

        // envia el valor del permiso de usuario del dashboard
        node.grupo_acceso = login_user;
    ...
    _onCloseAction: function (event) {
        ...
        Dialog.confirm(this, (_t("Realmente desea eliminar el diseño del dashboard?")), {
...
odoo.define('sicpro_app_contratos.viewRegistry', function (require) {
"use strict";

var BoardView = require('sicpro_app_contratos.BoardView');
