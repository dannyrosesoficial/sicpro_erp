odoo.define('sicpro_app_contratos.tax_group', function (require) {
    "use strict";
    ...
    var TaxGroupCustomField = AbstractField.extend({
        ...
        _changeTaxValueByTaxGroup: function (taxGroupId, deltaAmount) {
            ...
            self.trigger_up('field_changed', {
                ...
                changes: { line_ids: { operation: "UPDATE", id: line_id.id, data: { amount_currency: amount_currency, debit: debitAmount, credit: creditAmount } } }, // sicpro.app.contratos.movimiento change
                initialEvent: { dataPointID: line_id.id, changes: { amount_currency: amount_currency, debit: debitAmount, credit: creditAmount }, }, // sicpro.app.contratos.movimiento.line change
            });
        },
