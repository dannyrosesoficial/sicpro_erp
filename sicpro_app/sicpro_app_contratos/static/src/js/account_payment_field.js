odoo.define('sicpro_app_contratos.payment', function (require) {
"use strict";
...
var ShowPaymentLineWidget = AbstractField.extend({
    ...
    _onOpenPayment: function (event) {
        ...
        if (paymentId !== undefined && !isNaN(paymentId)){
            res_model = "sicpro.app.contratos.pago";
            id = paymentId;
        } else if (moveId !== undefined && !isNaN(moveId)){
            res_model = "sicpro.app.contratos.movimiento";
            id = moveId;
        }
        //Open form view of sicpro.app.contratos.movimiento with id = move_id
        if (res_model && id) {
            this.do_action({
    ...
    _onRemoveMoveReconcile: function (event) {
        ...
        if (paymentId !== undefined && !isNaN(paymentId)){
            this._rpc({
                model: 'sicpro.app.contratos.movimiento.line',
