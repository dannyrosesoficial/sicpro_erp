odoo.define('sicpro_app_contratos.ReconciliationClientAction', function (require) {
"use strict";

var AbstractAction = require('web.AbstractAction');
var ReconciliationModel = require('sicpro_app_contratos.ReconciliationModel');
var ReconciliationRenderer = require('sicpro_app_contratos.ReconciliationRenderer');
var core = require('web.core');
var QWeb = core.qweb;


/**
 * Widget used as action for 'sicpro.app.contratos.banco' reconciliation
 */
var StatementAction = AbstractAction.extend({
    ...
    init: function (parent, params) {
        ...
        this.params = params;
        this.controlPanelParams.modelName = 'sicpro.app.contratos.banco.line';
        this.model = new this.config.Model(this, {
            modelName: "sicpro.app.contratos.conciliacion",
    ...
    willStart: function () {
        ...
        return def.then(function () {
                ...
                if (self.params.context.journal_id) {
                    ...
                    self.model.context.active_model = 'sicpro.app.contratos.diario';
                }
                if (self.model.context.active_id && self.model.context.active_model === 'sicpro.app.contratos.diario') {
                    var promise = self._rpc({
                            model: 'sicpro.app.contratos.diario',
                            method: 'read',
    ...
    _onCloseStatement: function (event) {
        ...
        return this.model.closeStatement().then(function (result) {
            self.do_action({
                ...
                res_model: 'sicpro.app.contratos.banco.line',
                res_id: result,
                views: [[false, 'form']],
...
/**
 * Widget used as action for 'sicpro.app.contratos.movimiento.line' and 'res.partner' for the
