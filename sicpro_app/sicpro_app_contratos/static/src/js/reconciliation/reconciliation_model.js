odoo.define('sicpro_app_contratos.ReconciliationModel', function (require) {
"use strict";
...
/**
 * Model use to fetch, format and update 'sicpro.app.contratos.conciliacion',
...
var StatementModel = BasicModel.extend({
    ...
    closeStatement: function () {
        var self = this;
        return this._rpc({
                model: 'sicpro.app.contratos.banco.line',
     ...
     * load data from
     *
     * - 'sicpro.app.contratos.banco' fetch the line id and bank_statement_id info
     * - 'sicpro.app.contratos.conciliacion.model'  fetch all reconcile model (for quick add)
     * - 'account.account' fetch all account code
     * - 'sicpro.app.contratos.conciliacion' fetch each line data
     *
     * overridden in ManualModel
    ...
    loadData: function(ids) {
        ...
        return self._rpc({
            model: 'sicpro.app.contratos.conciliacion',
    ...
    reload: function() {
        ...
        if (self.context && self.context.active_model === 'sicpro.app.contratos.diario' && self.context.active_ids) {
    ...
    _loadTaxes: function(){
        ...
        self.taxes = {};
        return this._rpc({
                model: 'sicpro.app.contratos.tax',
                method: 'search_read',
    ...
    /**
     * Format the value and send it to 'sicpro.app.contratos.conciliacion' model
    ...
    /**
     * Fetch 'sicpro.app.contratos.conciliacion' propositions.
     * overridden in ManualModel
     *
     * @see '_formatMoveLine'
     *
     ...
     * @private
     * @param {Object} data
     * @param {Object[]} data.moves list of processed sicpro.app.contratos.movimiento
     * @returns {Deferred}
     */
...
/**
 * Model use to fetch, format and update 'sicpro.app.contratos.movimiento.line' and 'res.partner'
...
var ManualModel = StatementModel.extend({
    ...
    /**
     * load data from
     * - 'sicpro.app.contratos.conciliacion' fetch the lines to reconciliate
     * - 'account.account' fetch all account code
     *
     * @param {Object} context
    ...
    /**
     * Fetch 'sicpro.app.contratos.movimiento.line' propositions.
     *
     * @see '_formatMoveLine'
     *
     * @override
