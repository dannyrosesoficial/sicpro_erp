odoo.define('sicpro_app_contratos.ReconciliationRenderer', function (require) {
"use strict";
...
var StatementRenderer = Widget.extend(FieldManagerMixin, {
    ...
    /**
     * Open the list view for sicpro.app.contratos.banco model
     * @private
     * @param {MouseEvent} event
     */
    _onGoToBankStatement: function (e) {
        ...
        this.do_action({
            ...
            res_model: 'sicpro.app.contratos.banco',
            views: [[false, 'list'], [false, 'form']],
            type: 'ir.actions.act_window',
...
var LineRenderer = Widget.extend(FieldManagerMixin, {
    ...
    _makePartnerRecord: function (partnerID, partnerName) {
        ...
        return this.model.makeRecord('sicpro.app.contratos.banco.line', [field], {
            partner_id: {
    ...
    _renderCreate: function (state) {
        var self = this;
        return this.model.makeRecord('sicpro.app.contratos.banco.line', [{
            relation: 'sicpro.app.contratos',
            type: 'many2one',
            name: 'account_id',
            domain: [['company_id', '=', state.st_line.company_id], ['deprecated', '=', false]],
        }, {
            relation: 'sicpro.app.contratos.diario',
            type: 'many2one',
            name: 'journal_id',
            domain: [['company_id', '=', state.st_line.company_id]],
        }, {
            relation: 'sicpro.app.contratos.tax',
            type: 'many2many',
            name: 'tax_ids',
            domain: [['company_id', '=', state.st_line.company_id]],
        }, {
...
var ManualLineRenderer = LineRenderer.extend({
    ...
    start: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            return self.model.makeRecord('sicpro.app.contratos.movimiento.line', [{
                relation: 'sicpro.app.contratos',
                type: 'many2one',
                name: 'account_id',
