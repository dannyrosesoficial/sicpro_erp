...
class LoginUserReport(models.Model):
    ...
    start_date = fields.Datetime(required=True, string="Fecha Inicial", default=fields.Datetime.now())
    end_date = fields.Datetime(required=True, string="Fecha Final", default=fields.Datetime.now())
    type = fields.Selection([('all', 'Todos los Usuarios'), ('selected', 'Seleccionar Usuario')],
    ...
    def generar_reporte(self):
        return self.env.ref('sicpro_modulo_usuario_registro.reporte_registro_usuario_report').report_action([], )
