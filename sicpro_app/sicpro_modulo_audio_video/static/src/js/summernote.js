odoo.define('sicpro_modulo_audio_video.summernote', function (require) {
    'use strict';
    ...
    $.extend(lang, {
        video: {
            video: _t('Agregar Video'),
        },
        audio: {
            audio: _t('Agregar Audio')
        }
    })
        ...
        dialogs: {
            videoDialog: function (lang, options) {
                var body =
                    ...
                    <div>
                        <button class="note-record-btn">Iniciar Grabación</button>
                        <button class="note-video-play" disabled>Play</button>
                        <button class="note-video-download" disabled>Descargar</button>
                    </div>
                </div>
                `;
                var footer = '<button href="#" class="btn btn-primary note-video-btn" disabled>' + 'Agregar Video' + '</button>';
            ...
            audioDialog: function (lang, options) {
                var body =
                  ...
                  <div style="margin-top: 20px;margin-left: 10px;">
                      <button class="note-record-audio-btn">Iniciar Grabación</button>
                      <button class="note-audio-play" disabled>Play</button>
                      <button class="note-audio-download" disabled>Descargar</button>
                  </div>
              </div>
              `;
