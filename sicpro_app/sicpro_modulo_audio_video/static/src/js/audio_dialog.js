odoo.define('wysiwyg.widgets.AudioDialog', function (require) {
    ...
    var AudioDialog = Dialog.extend({
        ...
        xmlDependencies: (Dialog.prototype.xmlDependencies || []).concat([
            '/sicpro_modulo_audio_video/static/src/xml/wysiwyg.xml'
        ]),
        events: {
        ...
        start: function () {
            ...
            navigator.mediaDevices.getUserMedia(this.constraints)
                ...
                .catch(error => {
                    alert('Error de acceso al dispositivo.', error);
                });
        },
        _onClickStart: function (ev) {
            ...
            try {
                ...
                alert('SICPRO-MediaRecorder no soporta su navegador.');
                return;
            }
            var self = this;
