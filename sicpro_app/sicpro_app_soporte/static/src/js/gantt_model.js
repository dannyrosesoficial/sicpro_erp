odoo.define('sicpro_app_soporte.GanttModel', function (require) {
    "use strict";
    ...
    var GanttModel = AbstractModel.extend({
        ...
        createLink: function(data){
            ...
            values.id = data.id;
            values.tarea_id = data.source;
            values.dependencias_id = data.target;
            values.tipo_relacion = data.type;
