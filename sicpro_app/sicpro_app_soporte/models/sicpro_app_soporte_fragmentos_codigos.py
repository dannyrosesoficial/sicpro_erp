...
class SoporteFragmentosCodigos(models.Model):
    ...
    user_id = fields.Many2one('res.users', string='Creado por', index=True, required=True,
    ...
    tipo_codigo = fields.Selection(string='Tipos de Código',
                                   selection=[('python', 'Código Python'), ('xml', 'Código Xml'),
                                              ('otros', 'Otros Códigos'), ], required=True, )
