...
class SoporteTrabajadores(models.Model):
    ...
    ticket_count = fields.Integer(compute="_compute_cuenta_ticket",
        string="Cantidad Ticket")
    ...
    def action_view_soporte_tickets(self):
        return {"name": self.name, "view_type": "form",
            "view_mode": "list,form", "res_model": "sicpro.app.soporte",
