...
var ResumeLineRenderer = AbstractGroupedOne2ManyRenderer.extend({
    ...
    _formatData: function (data) {
        ...
        var date_end = data.date_end && data.date_end.format(dateFormat) || _t("Pendiente de Actualizar");
        var fecha_expiracion = data.fecha_expiracion && data.fecha_expiracion.format(dateFormat) || "";
