odoo.define('sicpro_app_trabajadores/static/src/models/employee/employee.js', function (require) {
'use strict';
...
function factory(dependencies) {
    ...
    class Employee extends dependencies['mail.model'] {
        ...
        static async performRpcRead({ context, fields, ids }) {
            ...
            this.env.models['sicpro.app.trabajadores'].insert(employeesData.map(employeeData =>
                this.env.models['sicpro.app.trabajadores'].convertData(employeeData)
            ));
        }
         ...
         */
        async checkIsUser() {
            return this.env.models['sicpro.app.trabajadores'].performRpcRead({
                ids: [this.id],
    ...
    Employee.modelName = 'sicpro.app.trabajadores';

    return Employee;
}

registerNewModel('sicpro.app.trabajadores', factory);
