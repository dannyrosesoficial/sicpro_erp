...
class TrabajadoresEducacionCertificacion(models.Model):
    ...
    name = fields.Char(string='Nombre de la Empresas Nacional Certificadora de Personas', required=True)
    vigencia = fields.Integer(string='Vigencia (Años)', required=True)
    dias = fields.Integer(string='Días', required=False, compute='_compute_dias_vigencia')
