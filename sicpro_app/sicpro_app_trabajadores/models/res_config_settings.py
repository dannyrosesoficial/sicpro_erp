...
class ResConfigSettings(models.TransientModel):
    ...
    resource_calendar_id = fields.Many2one(
        'resource.calendar', 'Horas laborales',
    ...
    hr_presence_control_login = fields.Boolean(
        ...
        config_parameter='sicpro_app_trabajadores.hr_presence_control_login')
    ...
    hr_employee_self_edit = fields.Boolean(
        string="Employee Edition",
        config_parameter='sicpro_app_trabajadores.trabajadores_self_edit')
