...
class ResUsersRole(models.Model):
    ...
    line_ids = fields.One2many(comodel_name="sicpro.modulo.roles.line",
                               inverse_name="role_id", string="Roles lines")
    ...
    group_category_id = fields.Many2one(
        ...
        default=lambda cls: cls.env.ref("sicpro_modulo_roles.ir_module_category_role").id,
        string="Asociar Categoría", readonly=False,)
...
class ResUsersRoleLine(models.Model):
    ...
    _description = "Usuarios asociado a los roles"

    role_id = fields.Many2one(comodel_name="sicpro.modulo.roles",
                              required=True, string="Roles", ondelete="cascade")
    user_id = fields.Many2one(
        comodel_name="res.users", required=True, string="Usuarios",
