...
class ResUsers(models.Model):
    ...
    role_line_ids = fields.One2many(
        comodel_name="sicpro.modulo.roles.line", inverse_name="user_id",
        string="Roles lines", default=lambda self: self._default_role_lines(),)
    role_ids = fields.One2many(
        comodel_name="sicpro.modulo.roles", string="Roles",
    ...
    def set_groups_from_roles(self, force=False):
        ...
        for user in self:
            ...
            group_ids = list(set(group_ids))  # Eliminar duplicados IDs
