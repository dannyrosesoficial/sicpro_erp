odoo.define('sicpro_modulo_firma_digital.sicpro_modulo_firma_digital', function (require) {
    "use strict";
    ...
    var FieldSignature = BasicFields.FieldBinaryImage.extend( {
        ...
        jsLibs: ['/sicpro_modulo_firma_digital/static/lib/jSignature/jSignatureCustom.js'],
