...
class SimularUsuario(models.TransientModel):
    _name = "sicpro.modulo.simular.usuario"
    _description = "Simular usuario"
    ...
    def login_simulation(self, redirect=None):
        ...
        if request.httprequest.method == "POST":
            ...
            request.uid = old_uid
            values["error"] = _("Login/Password Incorrecto")
        else:
            if "error" in request.params and request.params.get("error") == "access":
                values["error"] = _(
                    "Solo un trabajador puede acceder a esta base de datos. "
