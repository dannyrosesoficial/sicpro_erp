odoo.define('sicpro_app_credenciales.ImageCropWidget', function (require) {
'use strict';

const core = require('web.core');
const Widget = require('web.Widget');
const {applyModifications, cropperDataFields, activateCropper, loadImage, loadImageInfo} = require('sicpro_app_credenciales.image_processing');

const _t = core._t;

const ImageCropWidget = Widget.extend({
    template: ['sicpro.credenciales.crop'],
    xmlDependencies: ['/sicpro_app_credenciales/static/src/xml/templates.xml'],
    events: {
