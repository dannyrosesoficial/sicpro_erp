...
class ImageImporterWizard(models.TransientModel):
    ...
    _description = "Importar imagen desde csv or xls wizard"
    ...
    model_id = fields.Many2one("ir.model", string="Modelo", domain=get_model_domain)
    binary_field_id = fields.Many2one("ir.model.fields", string="Campo de Imagen")
    file_input = fields.Binary(string="Archivo", help="select csv or xls file")
    ...
    def check_xlsx_file(self):
        try:
            ...
            raise UserError(_("Please Upload valid Excel File."))
