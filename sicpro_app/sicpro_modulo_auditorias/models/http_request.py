...
class AuditlogHTTPRequest(models.Model):
    _name = "sicpro.modulo.auditorias.http.request"
    _description = "Auditorias - peticiones HTTP log"
    ...
    log_ids = fields.One2many("sicpro.modulo.auditorias.log", "http_request_id", string="Logs")
