...
class AuditlogtHTTPSession(models.Model):
    _name = "sicpro.modulo.auditorias.http.session"
    _description = "Auditorias - sesiones de usuarios HTTP log"
    ...
    http_request_ids = fields.One2many(
        "sicpro.modulo.auditorias.http.request", "http_session_id", string="HTTP Requests"
    )
