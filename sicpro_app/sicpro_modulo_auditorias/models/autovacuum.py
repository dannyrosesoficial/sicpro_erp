...
class AuditlogAutovacuum(models.TransientModel):
    _name = "sicpro.modulo.auditorias.autovacuum"
    _description = "Auditorias - Eliminar registros logs antiguos"
    ...
    def autovacuum(self, days):
        ...
        data_models = ("sicpro.modulo.auditorias.log", "sicpro.modulo.auditorias.http.request", "sicpro.modulo.auditorias.http.session")
