...
class MetrologiaDirecciones(models.Model):
    ...
    # Para el dashboard
    todo_request_ids = fields.One2many('sicpro.app.metrologia.equipos',
                                       string="Requests", copy=False,
    ...
    def _compute_todo_requests(self):
        for team in self:
            ...
            team.todo_request_planificado = len(
                team.todo_request_ids.filtered(lambda e: e.aviso_mtto == True))
