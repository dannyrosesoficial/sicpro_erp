...
class IrHttp(models.AbstractModel):
    ...
    def session_info(self):
        ...
        try:
            result['interval'] = self.env['res.config.settings'].sudo().search_read(
...
class ServerInfoSettings(models.TransientModel):
    ...
    update_frequency = fields.Selection(string='Frecuencia de actualización', default=_get_current_frequency,
                                        selection=[('1000', '1 Sec'), ('2000', '2 Sec'), ('5000', '5 Sec'),
                                                   ('10000', '10 Sec'), ('30000', '30 Sec'), ('60000', '1 Min'),
                                                   ('300000', '5 Min')],  required=True
    )
